...
import heroPoster from './assets/new/BGBanner.jpeg';
import ownerPortrait from './assets/new/Owner1.png';
import ownerAtBranch from './assets/new/Owner.png';
import branchLogoWithOwner from './assets/new/Name_Logo_With_Owner.png';
...
export const BRANCHES = [
  {
    ...
    managerNameMr: 'प्रा. मनोज सुरवसे',
    ...
    mr: { name: 'हॉटेल धाराशिवचे मातोश्री', address: 'MH SH 67, तांबरी विभाग, धाराशिव, महाराष्ट्र 413501' },
  ...
  },
  {
    ...
    city: 'Barshi',
    cityMr: 'बार्शी',
    photo: branchLogoWithOwner,
    imageFit: 'contain',
    imagePosition: 'center',
    ownerName: 'Prof. Manoj Surwase',
    managerName: 'Nikhil Dabade',
    managerNameMr: 'निखिल दबडे',
    ...
    mr: { name: 'हॉटेल धाराशिवचे मातोश्री (शाखा 2)', address: '6MHM+J64, छत्रपती कॉलनी, बार्शी, महाराष्ट्र 413411' },
  ...
  },
  {
    ...
    managerNameMr: 'राहुल राजेंद्र जगदाळे',
    ...
    mr: { name: 'हॉटेल धाराशिवचे मातोश्री (शाखा 3)', address: 'माळबा हॉस्पिटलसमोर, चव्हाण कॉम्प्लेक्स, परभणी, तुळजापूर, महाराष्ट्र 413601' },
  ...
  },
  {
    ...
    mr: { name: 'हॉटेल धाराशिवचे मातोश्री (शाखा 5)', address: 'शॉप नं. 1, मेन रोड, बस स्टॉपजवळ, काशिलिंगेश्वर नगर, महाराष्ट्र 413531' },
  ...
  },
  {
    ...
    mr: { name: 'हॉटेल धाराशिवचे मातोश्री (शाखा 11)', address: 'आझाद हिंद चौक, मेकॅनिक चौक, सोलापूर, महाराष्ट्र 413002' },
  ...
  },
  {
    ...
    managerNameMr: 'प्रवीण (अण्णा) धाबेकर',
    ...
    mr: { name: 'हॉटेल धाराशिवचे मातोश्री (शाखा 18)', address: 'साई आनंद लॉन्सजवळ, पोखर्डी, अहिल्यानगर, महाराष्ट्र' },
  ...
  },
  {
    ...
    managerNameMr: 'श्रीकांत सुभाष साळुंके',
    ...
    mr: { name: 'हॉटेल धाराशिवचे मातोश्री (शाखा 24)', address: 'राजीव गांधी चौक, RJ कॉम्प्लेक्सजवळ, औसा रोड, लातूर, महाराष्ट्र 413512' },
  ...
  },
  {
    ...
    mr: { name: 'हॉटेल मातोश्री चहावाला', address: 'जिजाऊ चौक, बार्शी नाका, धाराशिव, महाराष्ट्र' },
  ...
  },
  {
    ...
    managerNameMr: 'मातोश्री चहा टीम',
    ...
    mr: { name: 'मातोश्री चहा + वडापाव फॉरमॅट', address: 'नमुना चहा फ्रँचायझी फॉरमॅट, लातूर, महाराष्ट्र' },
  ...
  },
  {
    ...
    managerNameMr: 'मातोश्री सप्लाय टीम',
    ...
    mr: { name: 'मातोश्री प्रीमिक्स सप्लाय मॉडेल', address: 'महाराष्ट्रातील निवडक भागीदार ठिकाणांसाठी उपलब्ध' },
